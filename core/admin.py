...
from .resources import EnhancedLayerResource, EnhancedServerResource


@admin.register(Server)
class ServerAdmin(ImportExportModelAdmin):
    """Admin for GIS servers"""
    resource_class = EnhancedServerResource
...
class LayerAdmin(ImportExportModelAdmin):
    ...
    resource_class = EnhancedLayerResource
...
admin.site.register(UserLayerPreference)
