...
class _Entity(_Call):
    ...
    def __init__(self, color=BYLAYER, extrusion=None, layer='0',
...
class LwPolyLine(_Entity):
    ...
    def __str__(self):
        ...
        #result += '\n70\n0'
        if self.width:
            result += '\n43\n%s' % self.width  #40 start width, 41 end width, 43 for constant width
...
class PolyLine(_Entity):
    def __init__(self, points, flag=0, width=None, closed=0, **common):
        _Entity.__init__(self, **common)
        self.points = points
        self.flag = flag
        self.width = width
    ...
    def __str__(self):
        ...
        if self.width:
            result += '\n40\n%s\n41\n%s' % (
                self.width, self.width)  #40 start width, 41 end width, 43 for constant width
        for point in self.points:
            result += '\n0\nVERTEX\n5\n2\n%s' % _point(point)
            result += '\n8\n0'
        result += '\n0\nSEQEND'
...
class TextLineType(_Call):
    """Custom linetype"""

    def __init__(self, name='continuous', description='Solid line',
                 elements=[], flag=64, height=2.5, string='S'):
    ...
    def __str__(self):
        return '0\nLTYPE\n2\n%s\n70\n%s\n3\n%s\n72\n65\n73\n3\n40\n%s\n49\n%s\n74\n0\n49\n%s\n74\n2\n46\n%s\n50\n0\n44\n0\n45\n%s\n9\n%s\n49\n%s\n74\n0' % (
            ...
            self.height * 6, self.height * 4, self.height, -0.5 * self.height, -0.5 * self.height, self.string,
            -0.5 * self.height)
...
def main():
    ...
    d.append(PolyLine(points=[[1, 1, 1], [2, 1, 1], [2, 2, 1], [1, 2, 1]],
                      closed=1, color=1, width=0.54))

    # d.saveas('C:/Users/danie/Desktop/test.dxf')
    d.saveas('C:/Users/junaid iqbal/PycharmProjects/EcommerceMap/test1.dxf')
